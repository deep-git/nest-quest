    ...
    return (
        <div className="mt-[70px] w-[90%] max-w-[700px] ml-auto mr-auto">
            ...
            {currentPage.confirmationPage && (
                <ConfirmationDetails mainDetails={mainDetails} additionalDetails={additionalDetails} images={images} handleCurrentPage={handleCurrentPage} handleConfirm={handleConfirm} isLoading={isLoading} handleCancel={handleCancel} />
            )}
        </div>
    )
}
